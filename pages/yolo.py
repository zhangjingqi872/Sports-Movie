...
sports = {
    "运动介绍":"拳击是指双方选手戴上特制的手套，在一定规则的限制下，运用合理、有效的攻防技术击中并战胜对手为目的的体育运动。","运动发展":"早在 20 世纪的上海，我国的现代拳击运动就已经出现了，那时还被称为是“西洋拳”。 拳击运动首次出现在旧中国第七届全运会上，新中国成立后，1959年第一届全运会筹委会把拳击作为大会竞赛项目。1979 年，世界著名拳王默罕默德阿里应邀访问我国。邓小平同志在接见阿里时指出“拳击运动也可以成为增进中美两国人民的了解和友谊的渠道”之后，我国拳击运动迎来了新一波的发展
                机会。拳击运动在我国正式得到恢复是在 1986 年 3 月，同年 8 月国家体委下发了一些有关发展拳击运动的文件。1987 年 4 月，中国拳击协会(CBF)正式成立，同年 6 月，中国拳击协会被 AIBA
                正式接纳为第 159 个会员。1988 年在韩国汉城（现首尔）举行的第 24 届奥运会
                上，我国山东拳击运动员刘栋进入了前 8 名，对于首次参加奥运会拳击项目的中
                国来说，无疑是一个相当不错的成绩。到了 1990 年在北京举办的第 11 届亚运会
...
with st.sidebar.expander(text,expanded=True):
    ...
    selected_sport = st.selectbox("请选择", list(sports.keys()))
    if selected_sport:
    st.write(sports[selected_sport])
