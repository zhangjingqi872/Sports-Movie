...
sports = {
    "运动介绍":"拳击是指双方选手戴上特制的手套，在一定规则的限制下，运用合理、有效的攻防技术击中并战胜对手为目的的体育运动。","运动发展":"早在 20 世纪的上海，我国的现代拳击运动就已经出现了，那时还被称为是
                “西洋拳”。 拳击运动首次出现在旧中国第七届全运会上，新中国成立后，1959
                年第一届全运会筹委会把拳击作为大会竞赛项目。1979 年，世界著名拳王默罕
                默德阿里应邀访问我国。邓小平同志在接见阿里时指出“拳击运动也可以成为增
