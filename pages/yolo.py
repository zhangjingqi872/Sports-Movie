...
if option == '运动简介':
    ...
    st.sidebar.markdown(
        f"""
        <div style="color:#ffdeb9; font-family: 宋体; height: 2320px; border: 1px solid rgba(49, 51, 63, 0.1); border-radius: 1rem; padding: calc(1em - 1px); background-color: rgba(255, 255, 255, 0.2);">
